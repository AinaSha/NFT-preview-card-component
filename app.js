...
body.append(wrapper);
wrapper.id = "wrapper";
wrapper.style.cssText ="max-width:1440px; margin: 0 auto;  margin-top: 160px; display:flex; justify-content:space-around;";
...
function createCard() {
   ...
   cardDiv.style.cssText ="width: 350px; height: 595px; background-color: hsl(216, 50%, 16%); border-radius: 15px; box-shadow: 0 20px 20px #0c1729, 0 30px 45px #0c192c; ";
...
function score(){
  return alert("Я оцениваю свою работу на 110 баллов");
}
